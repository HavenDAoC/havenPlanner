...
// Variable array for handling default or limitation values for
// the Strength character stat.
let sSTR = new Array();
// Variable array for handling default or limitation values for
// the Constitution character stat.
let sCON = new Array();
// Variable array for handling default or limitation values for
// the Dexterity character stat.
let sDEX = new Array();
// Variable array for handling default or limitation values for
// the Quickness character stat.
let sQUI = new Array();
// Variable array for handling default or limitation values for
// the Intelligence character stat.
let sINT = new Array();
// Variable array for handling default or limitation values for
// the Piety character stat.
let sPIE = new Array();
// Variable array for handling default or limitation values for
// the Empathy character stat.
let sEMP = new Array();
// Variable array for handling default or limitation values for
// the Charisma character stat.
let sCHA = new Array();

/* Character Race */

// Variable for identifying the character's race. Values are:
// 1 = Celt,
// 2 = Elf,
// 3 = Firbolg,
// 4 = Lurikeen,
...
/**
 * Resets stat and skill points to the values specified here.
 */
function clear() {
    // Default values for the builder form.

    $("#BASE").val('30'); // Default points that may be assigned to stats at level 1.
    $("#SPENT").val('0'); // Default value for skill points spent at level 1.
    $("#LEFT").val('0'); // Default value for skill points available at level 1.
    $("#BONUS").val('0'); // Default value for bonus skill points available at level 1.
    $("#LEVEL").val('1'); // Default value for character level.
    $("#SKILL").val('0'); // Default value for skill points available at level 1.
}

/**
 * Sets the standard parameters and values for a spell.
...
Styles[iStylePT++] = buildStylePT("Crush", "12", "Concussion", "You Parry", "Slowed", "Medium", "High", "High Bonus", "No Bonus", "Bone Crusher", "Target's attack speed reduced by 18% for 20 seconds.", "0,424");
...
Styles[iStylePT++] = buildStylePT("Crush", "21", "Protector", "", "Detaunt", "Medium", "Medium", "No bonus", "No Bonus", "", "Decrease your threat to monster targets by 19.", "0,000");
...
Styles[iStylePT++] = buildStylePT("Crush", "44", "Body Masher", "Skull Breaker", "Slowed", "Medium", "Medium", "Medium Bonus", "No Bonus", "", "Target's attack speed reduced by 34% for 20 seconds.", "0,740");
